...
"$VENV_DIR/bin/python" "$IMAGE_GEN" generate \
  ...
  --quality high \
  --size 2048x1152 \
  --prompt "Create a polished 16:9 desktop news website mockup for a premium product video scene. Resolution 1920x1080 feel, landscape. A brand-neutral Japanese-style online news portal is shown inside a large browser-like panel on a warm cream background. The visual mood should be stylish but slightly tense: breaking news bar, market stress, layoffs, economy, AI anxiety, restrained red accents, subtle dark editorial contrast, still clean and premium. The right side must be the most visually prominent area: create a large clean feature headline column with four empty story rows, strong hierarchy, generous blank text lanes, small category labels, comment icons, and subtle dividers. Do not put readable headline text in the right feature rows because Remotion will overlay Japanese headlines in Axis Std. The left side can contain smaller ranking cards, charts, thumbnail blocks, and generic UI fragments, but keep them secondary. Premium editorial technology brand video, high information density, modern news UI, white cards, warm cream environment, crisp typography, subtle shadows. No NewsPicks text. No real publication logos. No real company logos. No black hole. No cursor. Avoid text overflowing outside cards. Avoid fake Japanese gibberish in the prominent headline lanes." \
